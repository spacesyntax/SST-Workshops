...
|:----------------:|:--------------------------:|:------------:|:------------:|
|![image](./images/simpl/carriageway_bf.png)  | ![image](./images/simpl/courved_bf.png)  | ![image](./images/simpl/slip_1_bf.png)  | ![image](./images/simpl/slip_2_bf.png)  |
|   |   |   |   |   |
|![image](./images/simpl/carriageway_aft.png) | ![image](./images/simpl/courved_aft.png) | ![image](./images/simpl/slip_1_aft.png)  |![image](./images/simpl/slip_2_aft.png) |
...
|:----------------:|:--------------------------:|:------------:|
| ![image](./images/simpl/bridge_bf.png)  |![image](./images/simpl/stair_nodir_bf.png)   |![image](./images/simpl/stair_dir_bf.png)    |![image](./images/simpl/bridge_stair_1_bf.png)|![image](./images/simpl/bridge_stair_1_bf.png)|
|   |   |   |   |   |
| ![image](./images/simpl/bridge_aft.png)  |![image](./images/simpl/stair_nodir_aft.png)  |  ![image](./images/simpl/stair_dir_aft.png)    | ![image](./images/simpl/bridge_stair_1_aft.png) |  ![image](./images/simpl/bridge_stair_2_bf.png)|   

**Roundabouts examples**

|With buildings | Without buildings |
|:---------------:|:-------------------:|
|![image](./images/simpl/rndabout_build_bf.png)|![image](./images/simpl/rndabout_nobuild_bf.png)|
|   |   |
|![image](./images/simpl/rndabout_build_aft.png)| ![image](./images/simpl/rndabout_nobuild_aft.png)|

**Open spaces examples**      

|Parks |   |   | Gated parks/ gardens|
|:------:|:---:|:---:|:---------------------:|
| ![image](./images/simpl/openpark_1_bf.png)   |![image](./images/simpl/openpark_2_bf.png)  |![image](./images/simpl/openpark_3_bf.png)  | ![image](./images/simpl/gatedpark_bf.png)  |
|   |   |   |   |
| ![image](./images/simpl/openpark_1_aft.png) |![image](./images/simpl/openpark_2_aft.png) |![image](./images/simpl/openpark_3_aft.png)  | ![image](./images/simpl/gatedpark_aft.png) |

**Squares and Open spaces**

|Rectangular open spaces/ squares |   |   | Triangular open spaces/ squares|
|:---------------------------------:|:---:|:---:|:--------------------------------:|
| ![image](./images/simpl/recsquare_1_bf.png) | ![image](./images/simpl/recsquare_2_bf.png) |![image](./images/simpl/recsquare_3_bf.png)|![image](./images/simpl/trisquare_bf.png)|
|   |   |   |   |
| ![image](./images/simpl/recsquare_1_aft.png)  |![image](./images/simpl/recsquare_2_aft.png) |![image](./images/simpl/recsquare_3_aft.png)|![image](./images/simpl/trisquare_aft.png) |

**Staggered junctions**

|Trivial rings | Short lines|
|:--------------:|:------------:|
| ![image](./images/simpl/trival_bf.png)| ![image](./images/simpl/shortl_bf.png)   |![image](./images/simpl/staggered_1_bf.png)|![image](./images/simpl/staggered_2_bf.png)|
|   |   |   |   |
| ![image](./images/simpl/trival_aft.png) |![image](./images/simpl/shortl_aft.png) |![image](./images/simpl/staggered_1_aft.png) |![image](./images/simpl/staggered_2_aft.png) |
